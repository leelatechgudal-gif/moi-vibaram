...
export default function CreateMoi() {
    ...
    const [form, setForm] = useState({
        eventId: '', partyName: '', spouseName: '', nickname: '',
                ...
                <div className="card" style={{ marginBottom: 16 }}>
                    ...
                    <div className="form-grid">
                        ...
                        <div className="form-group">
                            ...
                            <input className="form-control" name="cashAmount" type="number" min="0" value={form.cashAmount} onChange={onChange} placeholder="0" />
                        </div>
                    </div>
                </div>
                ...
                <div className="card" style={{ marginBottom: 16 }}>
                    ...
                    <div className="form-grid">
                        ...
                        <div className="form-group">
                            ...
                            <input className="form-control" name="spouseName" value={form.spouseName} onChange={onChange} placeholder="Spouse name" />
                        </div>
                        <div className="form-group">
                        ...
                        <div className="form-group">
                            ...
                            <input className="form-control" name="location" value={form.location} onChange={onChange} placeholder="Town/Village" />
                        </div>
                        <div className="form-group">
